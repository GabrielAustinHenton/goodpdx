    ...
    <html lang="en" className={`${geist.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col bg-[#f8f7f4] text-gray-900">
        ...
        <footer className="bg-[#0f2a1a] text-green-100 py-14 mt-8">
          <div className="max-w-6xl mx-auto px-5 flex flex-col md:flex-row items-start gap-10 md:gap-0">
            {/* Link columns — top on mobile, left on desktop */}
            <div className="flex gap-20 order-first md:order-none">
              <div>
            ...
            {/* Good PDX box — bottom on mobile, right on desktop */}
